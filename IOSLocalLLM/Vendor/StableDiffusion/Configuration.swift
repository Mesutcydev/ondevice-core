...
struct UNetConfiguration: Codable {
    ...
    /// `mid_block_type` from the diffusers UNet config. "UNetMidBlock2D" means a
    /// plain mid block with NO cross attention (distilled SDXL: Segmind Vega /
    /// SSD-1B); anything else (e.g. "UNetMidBlock2DCrossAttn") has cross
    /// attention. `UNetMidBlock` keys off this so both kinds load.
    public var midBlockType: String? = nil
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case midBlockType = "mid_block_type"
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.midBlockType = try container.decodeIfPresent(String.self, forKey: .midBlockType)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.midBlockType, forKey: .midBlockType)
    }
}
